...
app.post("/attack-normal", async (req, res) => {
    ...
    let 레어몬스터이름 = null;
    if (Math.random() < 1 / 18000) 레어몬스터이름 = "바론";
    else if (Math.random() < 1 / 9000) 레어몬스터이름 = "사탄";
    else if (Math.random() < 1 / 3000) 레어몬스터이름 = "벨제부브";
    else if (Math.random() < 1 / 900) 레어몬스터이름 = "레비아탄";
    else if (Math.random() < 1 / 450) 레어몬스터이름 = "메타트론";
...
app.post("/attack-rare", async (req, res) => {
    ...
    // ✅ 레어몬스터 등장 확률 추가
    let 새로운레어몬스터이름 = null;
    if (Math.random() < 1 / 18000) 새로운레어몬스터이름 = "바론";
    else if (Math.random() < 1 / 9000) 새로운레어몬스터이름 = "사탄";
    else if (Math.random() < 1 / 3000) 새로운레어몬스터이름 = "벨제부브";
    else if (Math.random() < 1 / 900) 새로운레어몬스터이름 = "레비아탄";
    else if (Math.random() < 1 / 450) 새로운레어몬스터이름 = "메타트론";
