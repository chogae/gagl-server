...
const 진화체인맵 = {
    ...
    "쉴드밴": ["쉴드밴", "쉴드배앤", "쉴드배애앤", "쉴드배애애앤", "쉴드배애애애앤", "쉴드배애애애애앤",], //방깍
    "고스트": ["고스트", "고오스", "고오스트", "팬텀", "메가팬텀", "팬텀거다이맥스",], //히든등장률
    "클로버": ["클로버", "월계수", "연꽃", "낙엽", "장미", "요정의날개",], //장뽑확률
    "하트플러스": ["하트플러스", "하트비트", "소망", "물약", "하트윙", "테크놀로지아",], //체력증가
    "하트마이너스": ["고오스트", "소망", "산산조각하트", "투핸드소드", "쉴드배애앤", "연꽃",], //체력깍
};
