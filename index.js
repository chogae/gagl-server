...
function 유물드랍판정(몬스터) {
    const 후보유물 = Object.keys(유물데이터); // 지금 작성한 유물들 전부 후보
    const 드랍확률 = 0.008; // 0.8% 예시 (층이나 몬스터 타입별로 나중에 조정 가능)
...
const 유물데이터 = {
    "소드": { 설명: "공격력이 1% 증가합니다", 효과: "공격력증가", 배율: 0.01 },
    "하트플러스": { 설명: "체력이 1% 증가합니다", 효과: "체력증가", 배율: 0.01 },
    "고스트": { 설명: "히든몬스터 등장률이 1% 증가합니다", 효과: "등장률증가", 배율: 0.01 },
    "쉴드밴": { 설명: "악마들의 방어력을 1% 감소시킵니다", 효과: "방어력감소", 배율: 0.01 },
    "하트마이너스": { 설명: "악마들의 체력을 1% 감소시킵니다", 효과: "체력감소", 배율: 0.01 },
    "엑스아이콘": { 설명: "크리티컬 피해량을 1% 증가시킵니다", 효과: "크리배율증가", 배율: 0.01 },
    // "ㅇㅇㅇㅇㅇㅇㅇ": { 설명: "ㅇㅇㅇㅇㅇ", 효과: "ㅇㅇㅇㅇ", 배율: 0.01 },
